...
public class Boss {
    ...
    public Boss(Rectangle bounds, Animation<Texture> animation) {
    	
    	this.hitbox = bounds;
    	this.hitbox.width = 64f;  // Largura da hitbox do Boss
        this.hitbox.height = 96f; // Altura da hitbox do Boss
